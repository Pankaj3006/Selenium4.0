...
public class RelativeLocators {
	...
	public static void main(String[] args)
	{
		...
		WebElement mouse = driver.findElement(By.xpath("//legend[contains(text(),'Suggession Class Example')]"));
	    System.out.println(driver.findElement(withTagName("input").below(mouse)).getText());
